...
function Headerpart(){
  ...
  {/*left*/}
    <div className="flex items-center space-x-2 w-full max-w-xs">
     ...
     <div className="flex items-center space-x-1 dark:md:bg-gray-700 py-2.5 rounded w-full">
     <SearchRoundedIcon/>
   ...
   <HeaderLink Icon={HomeRoundedIcon} text="Home" feed active className="hover:text-blue-600"  />
